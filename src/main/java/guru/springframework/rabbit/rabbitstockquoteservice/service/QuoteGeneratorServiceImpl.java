...
public class QuoteGeneratorServiceImpl implements QuoteGeneratorService {
    ...
    public QuoteGeneratorServiceImpl() {
        this.quotes.add(new Quote("AAPL", 132.26));
        this.quotes.add(new Quote("TSLA", 12.36));
        this.quotes.add(new Quote("NFLX", 32.46));
        this.quotes.add(new Quote("ARKK", 64.08));
        this.quotes.add(new Quote("SQ", 256.11));
        this.quotes.add(new Quote("DIS", 100.00));
        this.quotes.add(new Quote("MFST", 260.12));
        this.quotes.add(new Quote("PLTR", 23.16));
    }
